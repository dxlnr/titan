...
class Board:
    ...
    def __init__(self):
        ...
        self.R2_move_count_copy = None
        self.K_move_count_copy = None
        # current player's turn (0: white, 1: black)
        self.player = 0
    ...
    def move_rules_P(self, current_position):
        ...
        # en passant capture
            ...
            if (
                j - 1 == self.en_passant
                and abs(self.en_passant_move - self.move_count) == 1
            ):
    ...
    def move_rules_k(self):
        ...
        for a, b in [
            ...
            if 0 <= a <= 7 and 0 <= b <= 7:
                if (
                    self.current_board[a, b] in [" ", "Q", "B", "N", "P", "R"]
                    and (a, b) not in c_list
                ):
                    next_positions.append((a, b))
    ...
    def move_piece(self, initial_position, final_position, promoted_piece="Q"):
        if self.player == 0:
            ...
            if piece == "P":
                ...
                if (
                    abs(y - j) == 1 and self.current_board[i, j] == " "
                ):  # En passant capture
    ...
    def castle(self, side, inplace=False):
        if self.player == 0 and self.K_move_count == 0:
            if (
                side == "queenside"
                and self.R1_move_count == 0
                and self.current_board[7, 1] == " "
                and self.current_board[7, 2] == " "
                ...
                side == "kingside"
                and self.R2_move_count == 0
                and self.current_board[7, 5] == " "
                and self.current_board[7, 6] == " "
            ):
                if inplace == True:
        ...
        if self.player == 1 and self.k_move_count == 0:
            if (
                side == "queenside"
                and self.r1_move_count == 0
                and self.current_board[0, 1] == " "
                and self.current_board[0, 2] == " "
                ...
                side == "kingside"
                and self.r2_move_count == 0
                and self.current_board[0, 5] == " "
                and self.current_board[0, 6] == " "
            ):
                if inplace == True:
    ...
    def actions(self):
        """Returns all possible actions while not in check: initial_pos, final_pos, underpromote."""
        acts = []
        if self.player == 0:
            ...
            for (
                ...
                acts
            ):  # after move, check that its not check ownself, else illegal move
                i, f, p = act
